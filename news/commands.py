...
# article1 = Post.objects.create(author=author1, category=category1, post_type=articles,  post_title='Заголовок1', post_text='Текст1',)
# article2 = Post.objects.create(author=author2, category=category2, post_type='articles',  post_title='Заголовок2', post_text='Текст2',)
# news1 = Post.objects.create(author=author1, category=category3, post_type='news',  post_title='Заголовок3', post_text='Текст3',)

# comment1 = Comment.objects.create(post=article1, comment_text='Комментарий 1')
# comment1.like()
# comment1.dislike()
